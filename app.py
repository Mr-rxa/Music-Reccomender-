...
st.markdown(
    ...
    <style>
    .stApp {
        background: url("https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExcDQxenZwNGNhZGsyOW13MGE3aXJxanFjaDg4NWFyM2ZyaDhsdXBmNCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/JiSLuolECcoF1cqc4K/giphy.gif") no-repeat center center fixed; 
...
def get_music_recommendation(mood):
    mood_music = {
        ...
        "Motivated":[
            ...
            "Birad Ladgi - Masoom Sharma--https://www.youtube.com/watch?v=nHbdEle8wZg&pp=ygULYmlyYWQgbGFkZ2k%3D",
...
mood = st.selectbox("Select your mood:", ["happy", "sad", "energetic", "relaxed", "romantic","Motivated"])
